...
public class PathDef3<T1, T2, T3> extends AbstractPathDef
{
	...
	public PathDef3(PathSpec pathSpec, ParameterMapper<T1> mapper1,
	...
	public String getLink(T1 t1, T2 t2, T3 t3)
	{
